...
if not exist "C:\Windows\Temp\VBoxGuestAdditions.iso" (
    powershell -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; (New-Object System.Net.WebClient).DownloadFile('https://download.virtualbox.org/virtualbox/6.1.22/VBoxGuestAdditions_6.1.22.iso', 'C:\Windows\Temp\VBoxGuestAdditions.iso')" <NUL
)
